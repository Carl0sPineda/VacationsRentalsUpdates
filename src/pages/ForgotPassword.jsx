 ...
 function onChange(e) {
   ...
   async function onSubmit(e){
      ...
      try {
        ...
        toast.error("No se consiguio enviar el email a esa direccion de correo")
      }
   }
   ...
   <section>
     ...
     px-6 py-12 max-w-6xl mx-auto'>
       <div className='md:w-[67%] lg:w-[50%] mb-12 md:mb-6'>
         <img src="https://images.unsplash.com/photo-1599842079323-663d060a0f99?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MzV8fGNvc3RhJTIwcmljYSUyMGxvZ2lufGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60" 
         alt="key"
           ...
           <input
            ...
            rounded transition ease-in-out"/>
             ...
             <p> 
               ...
               hover:text-blue-800
               transition duration-200
               ease-in-out'>Inicia sesión</Link></p>
               </div>
           <button
