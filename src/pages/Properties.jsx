...
export default function Properties() {
  ...
  return (
    <div
      className="sm:mr-3 sm:ml-5 pt-4 space-y-6 mt-2"
      data-aos="fade-right"
    ...
    >
      ...
      <div className="flex md:flex-row space-y-2 md:space-y-0 md:space-x-10 justify-center sm: flex-col ml-2 mb-6">
        <div className="flex sm:flex space-x-8 justify-center">
          ...
          <div className="flex flex-col mt-2 md:flex-row md:items-center">
            <label className="text-lg text-center font-bold mr-4">Baños</label>
            <div className="text-center">
              <select
                className="cursor-pointer text-sm text-gray-700
          bg-white border border-gray-400 rounded transition
        ...
        <div className="flex sm:flex space-x-8 justify-center">
          <div className="flex flex-col mt-2 md:flex-row md:items-center">
            <label className="text-lg text-center font-bold mr-4">Precio</label>
        ...
        <>
          <main>
            {listings
              ...
              //verifica que existan propiedades con los filtros ingresados
              <>
